...
public class TableroGUI_Maquina extends javax.swing.JPanel{
    ...
    private CasillasGUI_Maquina [][] casillas ;
    ...
    public TableroGUI_Maquina() {
        initComponents();
    }

    public TableroGUI_Maquina(int filas,int columnas, boolean tipo) {
        initComponents();
        ...
        cargarImagenes();
        casillas = new CasillasGUI_Maquina[filas][columnas];//Tablero de jpanels
        this.filas=filas;
   ...
   @Deprecated
    ...
    public void inicializarCampo(){
        ...
        for (int i = 0; i < filas; i++){
            for (int j = 0; j < columnas; j++){
                casillas[i][j] = new CasillasGUI_Maquina(this); 
    ...
    protected static ImageIcon cargarFondo(String ruta) {
        java.net.URL localizacion = TableroGUI_Maquina.class.getResource(ruta);
    ...
    public int[] getCoordenadas(CasillasGUI_Maquina casilla) {
    ...
    public CasillasGUI_Maquina[][] getCasillas() {
        return casillas;
    }
    
    public void setCasillas(CasillasGUI_Maquina[][] casillas) {
